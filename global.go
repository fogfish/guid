...
// FromTG converts unix timestamp to globally unique k-ordered value
func FromTG(clock Chronos, t time.Time) G {
	return makeG(clock.Node(), clock.Drift(), uint64(t.UnixNano()), 0)
}
